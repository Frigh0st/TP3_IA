...
//-------------------------- ctor ---------------------------------------------
//-----------------------------------------------------------------------------
Bombe::Bombe(Raven_Bot* shooter, Vector2D target):
        ...
        Raven_Projectile(target,
                         ...
                         shooter->Pos(),
                         shooter->Facing(),
                         script->GetInt("Bombe_Damage"),
                         script->GetDouble("Bombe_Scale"),
                         script->GetDouble("Bombe_MaxSpeed"),
                         script->GetDouble("Bombe_Mass"),
                         script->GetDouble("Bombe_MaxForce")),
...
//-----------------------------------------------------------------------------
void Bombe::InflictDamageOnBotsWithinBlastRadius()
{
